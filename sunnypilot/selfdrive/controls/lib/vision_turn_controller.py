...
_ABORT_ENTERING_PRED_LAT_ACC_TH = 0.8  # Predicted Lat Acc threshold to abort entering state if speed drops.
...
_TURNING_ACC_BP = [1.5, 2.0, 3.]  # absolute value of current lat acc
