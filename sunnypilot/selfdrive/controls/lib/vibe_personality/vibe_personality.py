...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.1, -.5, -.9,  -1.15, -1.4],  # gentler braking
    LongPersonality.standard:   [-.1, -.5, -.9,  -1.15, -1.4],  # normal braking
    LongPersonality.aggressive: [-.1, -.5, -.9,  -1.15, -1.4],  # more aggressive braking
}
