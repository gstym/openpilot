...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-0.5, -0.7, -0.9,  -1.2, -1.3],  # gentler braking
    LongPersonality.standard:   [-0.5, -0.7, -0.9,  -1.2, -1.3],  # normal braking
    LongPersonality.aggressive: [-0.5, -0.7, -0.9,  -1.2, -1.3],  # more aggressive braking
}
