...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-0.6, -1.0, -1.5,  -1.5, -1.7],  # gentler braking
    LongPersonality.standard:   [-0.6, -1.0, -1.5,  -1.5, -1.7],  # normal braking
    LongPersonality.aggressive: [-0.6, -1.0, -1.5,  -1.5, -1.7],  # more aggressive braking
}
