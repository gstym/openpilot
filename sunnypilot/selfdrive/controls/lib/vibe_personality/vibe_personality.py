...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-0.6, -0.8, -1.0,  -1.2, -1.3],  # gentler braking
    LongPersonality.standard:   [-0.6, -0.8, -1.0,  -1.2, -1.3],  # normal braking
    LongPersonality.aggressive: [-0.6, -0.8, -1.0,  -1.2, -1.3],  # more aggressive braking
}
