...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-0.5, -0.7, -1.1,  -1.35, -1.5],  # gentler braking
    LongPersonality.standard:   [-0.5, -0.7, -1.1,  -1.35, -1.5],  # normal braking
    LongPersonality.aggressive: [-0.5, -0.7, -1.1,  -1.35, -1.5],  # more aggressive braking
}
