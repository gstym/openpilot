...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.0030, -.0030, -.6,  -.90, -1.2],  # gentler braking
    LongPersonality.standard:   [-.0030, -.0030, -.6,  -.90, -1.2],  # normal braking
    LongPersonality.aggressive: [-.0030, -.0030, -.6,  -.90, -1.2],  # more aggressive braking
}
MIN_ACCEL_BREAKPOINTS =         [0.,   1.5,    3.,   15.,  28.]
