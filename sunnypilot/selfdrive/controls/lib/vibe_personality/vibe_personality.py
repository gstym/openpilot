...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-0.6, -0.9, -1.2,  -1.35, -1.5],  # gentler braking
    LongPersonality.standard:   [-0.6, -0.9, -1.2,  -1.35, -1.5],  # normal braking
    LongPersonality.aggressive: [-0.6, -0.9, -1.2,  -1.35, -1.5],  # more aggressive braking
}
