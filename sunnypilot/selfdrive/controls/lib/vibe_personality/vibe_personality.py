...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.1, -.5, -.9,  -1.05, -1.2],  # gentler braking
    LongPersonality.standard:   [-.1, -.5, -.9,  -1.05, -1.2],  # normal braking
    LongPersonality.aggressive: [-.1, -.5, -.9,  -1.05, -1.2],  # more aggressive braking
}
MIN_ACCEL_BREAKPOINTS =         [0.,   1.5,    2.,   11.,  20.]
