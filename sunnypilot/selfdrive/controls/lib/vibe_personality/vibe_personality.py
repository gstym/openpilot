...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-0.8, -0.95, -1.1,  -1.2, -1.3],  # gentler braking
    LongPersonality.standard:   [-0.8, -0.95, -1.1,  -1.2, -1.3],  # normal braking
    LongPersonality.aggressive: [-0.8, -0.95, -1.1,  -1.2, -1.3],  # more aggressive braking
}
