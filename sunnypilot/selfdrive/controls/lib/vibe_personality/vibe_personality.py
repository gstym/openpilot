...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-1.5, -2.0, -2.5, -3.5],  # gentler braking
    LongPersonality.standard:   [-1.5, -2.0, -2.5, -3.5],  # normal braking
    LongPersonality.aggressive: [-1.5, -2.0, -2.5, -3.5],  # more aggressive braking
}
MIN_ACCEL_BREAKPOINTS =       [0.,  5.,   12.,  20.]
...
def get_dynamic_personality(v_ego, personality):
    ...
    scale_factor = np.interp(v_ego, [0, 18, 28], [0.6, 0.76, 1.0])
